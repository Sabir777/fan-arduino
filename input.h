...
class Input{
  ...
  private:
    int input;
    Switcher switcher; //антидребезг - получение достоверного состояния выключателя освещения
    ...
    Timer timer_off_forced; //таймер принудительного отключения при включенном состоянии: чтобы отключить вентилятор когда работает освещение нужно быстро выключить освещение и снова включить его, переход к нормальному алгоритму выключить освещение
